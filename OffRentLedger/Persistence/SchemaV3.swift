...
typealias Vendor = OffRentSchemaV3.VendorModel
typealias JobSite = OffRentSchemaV3.JobSiteModel
typealias RentalAgreement = OffRentSchemaV3.RentalAgreementModel
typealias RentalItem = OffRentSchemaV3.RentalItemModel
typealias RentalEvent = OffRentSchemaV3.RentalEventModel
typealias EvidenceAsset = OffRentSchemaV3.EvidenceAssetModel
typealias VendorInvoice = OffRentSchemaV3.VendorInvoiceModel
typealias InvoiceLine = OffRentSchemaV3.InvoiceLineModel
typealias Discrepancy = OffRentSchemaV3.DiscrepancyModel
