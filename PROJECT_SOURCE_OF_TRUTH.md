...
5. Final marketing artwork: the shipped app icon is an **original placeholder** (orange/graphite
   stop-clock geometry, generated by `scripts/generate_app_icon.py`). It is legally clean but is
   not finished brand work.
